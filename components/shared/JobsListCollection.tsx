...
const JobsListCollection = ({
  jobsData,
  emptyTitle,
  emptyStateSubtext,
}: JobsListCollectionProps) => {
  return (
    <>
      {jobsData.length > 0 ? (
        <div className="flex-center flex-col w-full">
          <ul className="flex w-full flex-col gap-5 xl:gap-10 lg:justify-center">
...
export default JobsListCollection;
